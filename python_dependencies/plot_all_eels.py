...
if __name__ == '__main__':
    ...
    try:
        (en_high,
         re_eps_high, im_eps_high,
         re_epsinv_high, im_epsinv_high) = load_eps_file(FILES['highq'])
        plot_eels(en_high, re_eps_high, im_eps_high,
                  re_epsinv_high, im_epsinv_high, q_label='highQ')
    except Exception as e:
        print("Could not plot high-q data:", e)
